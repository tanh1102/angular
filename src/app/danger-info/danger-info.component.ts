...
@Component({
  selector: 'app-danger-info',
  templateUrl: './danger-info.component.html',
  styleUrls: ['./danger-info.component.scss']
})
export class DangerInfoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    chart.data = [
      ...
      creditLabel.text = "Data source: notruededude";
