...
export class ChartsComponent implements OnInit {
  ...
  ngOnInit() {
    //create chart-column-bar instance
    ...
    continentsSeries.exclude = ["Antarcitica"];

    let contientTemplate = continentsSeries.mapPolygons.template;
    contientTemplate.tooltipText = "{name}";
    ...
    //countries
    let countriesSeires = map.series.push(new am4maps.MapPolygonSeries());
    let countries = countriesSeires.mapPolygons;
    countriesSeires.visible = false;
    countriesSeires.exclude = ["AQ"];
    countriesSeires.geodata = am4geodata_worldLow;
    countriesSeires.useGeodata = true;
    //hide each country so we can fade them in
    countriesSeires.events.once("inited", function(){
      hideCountries();
    });
    ...
    let labelContainer = map.chartContainer.createChild(am4core.Container);
    labelContainer.hide();
